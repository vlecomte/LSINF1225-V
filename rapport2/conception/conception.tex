...
Dans notre implémentation cela signifie que chaque fonction sera exécutée en une requête, ou du moins un nombre fixe, et que les classes DAO mémoriseront les données fixes pour qu'elles ne doivent être chargées qu'un fois même si les méthodes sont appelées plusieurs fois.

\section{Schéma UML}

Précisons maintenant la structure en nous appuyant sur le schéma UML fourni.
